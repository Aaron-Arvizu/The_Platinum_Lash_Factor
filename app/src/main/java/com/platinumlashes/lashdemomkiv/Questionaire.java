...
public class Questionaire extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        QuestionaireIntent= new Intent(Questionaire.this,LashReleaseActivity.class);
        ...
        BMonthAdapter = new ArrayAdapter<String>(Questionaire.this,R.layout.apptspinneritem,getResources().getStringArray(R.array.Months));
        BDayAdapter = new ArrayAdapter<String>(Questionaire.this,R.layout.apptspinneritem,getResources().getStringArray(R.array.Days));
    ...
    public void CheckText(){
        ...
        {
           Intent intent = new Intent(Questionaire.this,LashReleaseActivity.class);
    ...
    builder.setTitle("Do you want to go back to Main Menu?")
            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    Intent leaveIntent = new Intent(Questionaire.this,MainActivity.class);
